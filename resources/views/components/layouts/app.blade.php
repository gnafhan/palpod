...
<head>
    ...
    <style>
        ...
        :root{
          --primary-color: #001416;
          --secondary-color: #068790;
        
        }

        body{
          background: radial-gradient(210.24% 160.31% at -10.85% -3.96%, #151F25 46%, #0F202A 100%);
        } 
...
<body>
    <div class="d-flex align-items-center text-white rounded-pill px-4 mt-3"
        style="position:relative; height: 80px; z-index: 2; width: 95%; background-color: var(--primary-color) ; top: 2%; transform: translateX(-50%); left: 50%;">
        <img class="" src="/logop.png" alt="Logo" class="mx-4 " style="height: 50px; margin-left: 10px">
